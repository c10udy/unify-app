...
const About = () => {
  ...
  return (
    <div id="about" className="relative lg:flex md:p-6">
      <div
        className="md:p-6 text-center lg:w-1/2 self-center"
        data-aos="fade-up"
      >
        <h1 className="text-gray-900 text-4xl p-6 tracking-tight font-bold uppercase mt-4 md:mt-0">
